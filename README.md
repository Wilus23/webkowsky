# Webkowsky Website (Bootstrap)

This repository is the production codebase bootstrap for [Webkowsky.com](https://webkowsky.com), a B2B agency website for high-performance SaaS/software-house marketing sites and landing pages.
...
3. Start both Next.js app and Sanity Studio:
...
- `frontend/.env.local` is generated by the template and contains Sanity project settings.
- `frontend/.env.example` documents required frontend env variables:
